...
export default function NumberInputWithButtons() {
  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="number-buttons" className="text-sm font-medium text-foreground">Number Input with Buttons</Label>
      <div className="flex">
        <Button onClick={() => setValue(v => v - 1)}><Minus className="h-4 w-4" /></Button>
        <Input type="number" id="number-buttons" value={value} onChange={e => setValue(Number(e.target.value))} className="text-center" />
        <Button onClick={() => setValue(v => v + 1)}><Plus className="h-4 w-4" /></Button>
      </div>
    </div>
  );
}`}>
        <div className="space-y-2">
          <Label htmlFor="number-buttons" className="text-sm font-medium text-foreground">Number Input with Buttons</Label>
          <div className="flex">
            <Button onClick={() => setNumberValue(v => v - 1)}><Minus className="h-4 w-4" /></Button>
            <Input type="number" id="number-buttons" value={numberValue} onChange={e => setNumberValue(Number(e.target.value))} className="text-center" />
            <Button onClick={() => setNumberValue(v => v + 1)}><Plus className="h-4 w-4" /></Button>
          </div>
        </div>
      </InputComponent>
...
export default function NumberInputWithChevrons() {
  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="number-chevrons" className="text-sm font-medium text-foreground">Number Input with Chevrons</Label>
      <div className="flex">
        <Input type="number" id="number-chevrons" value={value} onChange={e => setValue(Number(e.target.value))} className="text-center" />
        <div className="flex flex-col">
          <Button onClick={() => setValue(v => v + 1)}><ChevronUp className="h-4 w-4" /></Button>
          <Button onClick={() => setValue(v => v - 1)}><ChevronDown className="h-4 w-4" /></Button>
        </div>
      </div>
    </div>
  );
        ...
        <div className="space-y-2">
          <Label htmlFor="number-chevrons" className="text-sm font-medium text-foreground">Number Input with Chevrons</Label>
          <div className="flex">
            <Input type="number" id="number-chevrons" value={chevronValue} onChange={e => setChevronValue(Number(e.target.value))} className="text-center" />
            <div className="flex flex-col">
              <Button onClick={() => setChevronValue(v => v + 1)}><ChevronUp className="h-4 w-4" /></Button>
              <Button onClick={() => setChevronValue(v => v - 1)}><ChevronDown className="h-4 w-4" /></Button>
            </div>
          </div>
        </div>
      </InputComponent>
