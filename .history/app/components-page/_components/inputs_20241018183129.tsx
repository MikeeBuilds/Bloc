...
export default function NumberInputWithChevrons() {
  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="number-chevrons" className="text-sm font-medium text-gray-700 dark:text-gray-200">Number Input with Chevron Buttons</Label>
      <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-md">
        <Input 
          ...
          onChange={e => setValue(Number(e.target.value))} 
          className="text-left bg-transparent border-none text-black dark:text-white focus:ring-0 pl-3 appearance-none"
          style={{ WebkitAppearance: 'none', MozAppearance: 'textfield' }}
        />
        <div className="flex flex-col">
          <Button onClick={() => setValue(v => v + 1)} className="px-2 py-1 bg-transparent hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400">
  ...
  <div className="space-y-2">
    ...
    <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-md">
      ...
      />
      <div className="flex flex-col">
        <Button onClick={() => setChevronValue(v => v + 1)} className="px-2 py-1 bg-transparent hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400">
          <ChevronUp className="h-4 w-4" />
        </Button>
        <Button onClick={() => setChevronValue(v => v - 1)} className="px-2 py-1 bg-transparent hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400">
          <ChevronDown className="h-4 w-4" />
