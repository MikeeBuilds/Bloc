...
export default function NumberInputWithButtons() {
  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="number-buttons" className="text-sm font-medium text-black dark:text-white">
        Number input with plus/minus buttons
      </Label>
      <div className="flex items-center rounded-md">
        <Button 
          onClick={() => setValue(v => v - 1)} 
          className="px-3 py-2 bg-transparent hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400"
        >
        ...
        <Input 
          ...
          className="text-center bg-transparent border-none text-black dark:text-white focus:ring-0 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
        />
        <Button 
          onClick={() => setValue(v => v + 1)} 
          className="px-3 py-2 bg-transparent hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400"
...
export default function NumberInputWithChevrons() {
  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="number-chevrons" className="text-sm font-medium text-black dark:text-white">
      ...
      <div className="flex items-center rounded-md">
        <Input 
          ...
          onChange={e => setValue(Number(e.target.value))} 
          className="text-left bg-transparent border-none text-black dark:text-white focus:ring-0 pl-3 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
        />
        <div className="flex flex-col">
          <Button 
            onClick={() => setValue(v => v + 1)} 
            className="px-2 py-1 bg-transparent hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400"
          >
