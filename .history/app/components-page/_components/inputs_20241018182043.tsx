...
export default function NumberInputWithButtons() {
  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="number-buttons" className="text-sm font-medium text-gray-200">Number input with plus/minus buttons</Label>
  ...
  <div className="space-y-2">
    <Label htmlFor="number-buttons" className="text-sm font-medium text-gray-200">Number input with plus/minus buttons</Label>
    <div className="flex items-center bg-gray-800 rounded-md">
      <Button onClick={() => setNumberValue(v => v - 1)} className="px-3 py-2 bg-transparent hover:bg-gray-700 text-gray-400">
        <Minus className="h-4 w-4" />
      </Button>
      <Input 
        type="number" 
...
export default function NumberInputWithChevrons() {
  ...
  <div className="space-y-2">
    ...
    <div className="flex items-center bg-gray-800 rounded-md">
      ...
      />
      <div className="flex flex-col">
        <Button onClick={() => setChevronValue(v => v + 1)} className="px-2 py-1 bg-transparent hover:bg-gray-700 text-gray-400">
          <ChevronUp className="h-4 w-4" />
        </Button>
        <Button onClick={() => setChevronValue(v => v - 1)} className="px-2 py-1 bg-transparent hover:bg-gray-700 text-gray-400">
          <ChevronDown className="h-4 w-4" />
