      ...
      <div className="relative z-10 flex-grow flex flex-col items-center justify-center text-center px-4 py-16">
        <div className="max-w-3xl mx-auto pb-24">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-black dark:border-gray-600 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
              <Link href="/docs">
                Read the docs
              </Link>
            </Button>
